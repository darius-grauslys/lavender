...
void m_process__game_action__hitbox(
    ...
    Vector__3i32 *p_dimenisons;
    Vector__3i32F4 *p_position_of__hitbox__3i32F4;
    Vector__3i32F4 *p_velocity_of__hitbox__3i32F4;
    Vector__3i16F8 *p_acceleration_of__hitbox__3i16F8;
