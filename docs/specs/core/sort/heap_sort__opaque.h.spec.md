# 1. Specification: core/include/sort/heap_sort__opaque.h
...
### 1.3.1 f_Sort_Heuristic__i32 (function pointer)
...
### 1.3.2 f_Sort_Swap__Void (function pointer)
