# 1. Specification: core/include/rendering/sprite_context.h
...
### 1.4.1 Initialization and Memory
...
### 1.4.2 Sprite Manager Allocation
...
### 1.4.4 Animation Registration (static inline)
...
### 1.4.5 Animation Group Registration (static inline)
