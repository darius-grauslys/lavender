# 1. Specification: core/include/sort/sort_list/sort_list.h
...
### 1.3.3 f_Sort_Heuristic (function pointer)
...
### 1.4.7 Allocation Management (static inline)
...
### 1.4.8 Configuration (static inline)
...
### 1.5.1 Cooperative Sorting Model
