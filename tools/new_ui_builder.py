...
def text_cstr(signature, xml_element, context_stack):
    name_of__ui_element = get_name_of__ui_element(context_stack)
    rectangle_spec = RectangleSpec(xml_element, context_stack)
    ...
    args = []
    args.append(name_of__ui_element)
    args.append(expression_to_get__font)
    args.append(text_argument)
    args.append(f"strnlen({text_argument}, 32)")
    ...
    transform_handler = get_str_from_xml_or__use_this(
            xml_element,
            "transform_handler",
            "m_ui_element__transformed_handler__text__centered")
    generate_source_c__signature(
            "set_ui_element__transformed_handler",
            [ name_of__ui_element, transform_handler ])
    generate_source_c__new_line()
...
def text_box(signature, xml_element, context_stack):
    name_of__ui_element = get_name_of__ui_element(context_stack)
    rectangle_spec = RectangleSpec(xml_element, context_stack)
    ...
    buffer_size = get_str_from_xml_or__use_this(
            xml_element,
            "buffer_size",
            "0")
