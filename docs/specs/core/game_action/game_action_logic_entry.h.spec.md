# Specification: core/include/game_action/game_action_logic_entry.h
...
### Game_Action_Logic_Entry (struct)
...
### Convenience Initializers (static inline)
